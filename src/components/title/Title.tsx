...
const PageData = {
  [DesignPagesEnum.Web]: {
    ...
    desktopBg: "md:bg-intro-web",
    desktopBgPosition: "md:webTitleBg-desktop",
  },
  [DesignPagesEnum.App]: {
    title: "App Design",
    description:
      "Our mobile designs bring intuitive digital solutions to your customers right at their fingerprints.",
    desktopBg: "md:bg-intro-app",
    desktopBgPosition: "md:appTitleBg-desktop",
  },
  [DesignPagesEnum.Graphic]: {
    title: "Graphic Design",
    description:
      "We deliver eye-catching branding materials that are tailored to meet your business objectives.",
    desktopBg: "md:bg-intro-graphic",
    desktopBgPosition: "md:graphicTitleBg-desktop",
  },
};
...
const Title = (props: ITitleProps) => {
  ...
  return (
    ...
    >
      <div className={"text-white text-[32px] leading-9 sm:text-5xl"}>
        {title}
      </div>
      <div
        className={
